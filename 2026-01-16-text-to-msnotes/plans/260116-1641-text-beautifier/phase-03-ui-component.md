...
## Objective
Build TextBeautifier component with two-panel layout and copy functionality.

## Tasks

### Task 3.1: Create TextBeautifier Component
Create `src/components/text-beautifier.tsx`:
```tsx
...
Replace `src/App.tsx`:
```tsx
import { TextBeautifier } from './components/text-beautifier';
...
- Type in left panel → see formatted output in right
- Copy button copies output to clipboard
- Paste into MS Teams → appears as bullet list

## Output
- Working TextBeautifier component
- Complete app ready for use
